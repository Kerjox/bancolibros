...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="addLibros.php" method="POST" enctype="multipart/form-data">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input id="isbn" class="input100" type="text" name="isbn" placeholder="Introduce el isbn aquí">
				...
				<div class="wrap-input100 validate-input" data-validate = "Se requiere un nombre valido">
					...
					<input id="titulo" class="input100" type="text" name="titulo" placeholder="Introduce el nombre del libro">
					<span class="focus-input100"></span>
				</div>
					...
					<div>
                        <select name="modulo" id="modulo" class="js-select2">
                            ...
                            while ($valores = mysqli_fetch_array($query)) {
                                ...
                                echo '<option value="' . $valores["IDmodulo"] . '">' . $valores["Modulo"] . " -- " . $valores["Ciclo"] . '</option>';
                            }
                            ?>
                        </select>
                ...
                <div class="wrap-input100">
                    ...
                    <select name="editorial" id="editorial" class="js-select2">
                            ...
                            while ($valores = mysqli_fetch_array($query)) {
                                ...
                                echo '<option value="' . $valores["IDeditorial"] . '">' . $valores["Editorial"] . '</option>';
                            }
                            ?>
                        </select>
						<div class="dropDownSelect2"></div>
                ...
                <div class="wrap-input100 validate-input" data-validate="Precio requerido">
					...
					<input id="precio" class="input100" type="text" name="precio" placeholder="Introduce el precio aquí">
					<span class="focus-input100"></span>
                </div>
