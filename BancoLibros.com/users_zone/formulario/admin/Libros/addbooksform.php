    ...
    <BODY>
        ...
        <form action="addbooks.php" method="POST" enctype="multipart/form-data">
            <table border="1" align="center" width="60%">
                <tr>
                    <td>Usuario</td>
                    <td><input type="text" name="usuario" maxlength="17" required></td>
                </tr>
                <tr>
                    <td>ISBN</td>
                    <td><input type="text" name="isbn" maxlength="17" size="25" required></td>
                </tr>
                <tr>
                    <td>Título</td>
                ...
                <tr>
                    <td>Precio</td>
                    <td><input type="text" name="precio" id="precio" placeholder="Poner decimales con punto" required></td>
                </tr>
                <tr>
                    <td>Disponible</td>
                    <td>
                ...
                <tr>
                    ...
                    <td><textarea name="comentarios" id="comentarios" cols="50" rows="5"></textarea></td>
                </tr>
                <tr>
