    ...
    <BODY>
        <div id="main-container">
            <table>
                <thead>
                <th>Usuario <a href="./?order=IDusuario" style="color: white"> <?php if ($_GET['order']=='IDusuario') {
                ...
                $sql = $conn->query("SELECT * FROM libros as l,modulos as m,editoriales as e WHERE (l.IDmodulo = m.IDmodulo AND l.IDeditorial = e.IDeditorial) $order");
                ...
                while ($valores = mysqli_fetch_array($sql)) {
                    echo "<tr>
                      ...
                      <td><a href='./editbooksform.php?id=$valores[IDlibro]' style='color: black'><i class='far fa-edit'></i></i></a></td>
                      <td><a href='./deletelibro.php?id=$valores[IDlibro]' style='color: red'><i class='far fa-trash-alt'></i></a></td>
                      </tr>";
                }
                ?>
            </table>
                <div><a href="/admin"><button><i class="fas fa-home"></i> Inicio</button></a> <a href="./addbooksform.php"><button><i class="fas fa-plus-circle"></i> Agregar Libro</button></a></div>
        </div>
    </BODY>
